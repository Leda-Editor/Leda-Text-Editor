...
This setup provides a seamless **experience**, making it ideal for Markdown-based documentation, note-taking, and blogging.  
...
|-------------------|-------------------------------|
| **Aleksy Siek**   | **Setup** - Helped initially kickstart the project with the layout and general repo structure. <br> **Key voice in team discussions** - actively shaping project direction and feature priorities. <br> **Leda pull request reviews** - providing feedback and ensuring high code quality. <br> **Directed feature implementation** - deciding what to build and how to approach key functionalities. <br> **Set up and maintained the CI pipeline** - ensuring stable builds across all platforms. <br> **Refactored and optimized code** - improving performance, maintainability, and fixing critical bugs. <br> **Enhanced documentation** - contributing to the **About section** and **README** for better project clarity. |
| **Mate Saary**    | **Project setup and organising** - Established the foundational structure of the project; creating initial files and documenting key feature, design, and technology use decisions. <br> **Code reviews & refactoring** - Responsible for conducting the vast majority of code reviews, including most key features/additions. Resolved various merge conflicts, refactored code, and conducted many "QA" role responsibilities. <br> **Supporting team workflow** - Assisted in setting up workflows and adapting to framework changes. <br> **Framework selection & Migration** - Actively contributed to many key decisions including the migration from one framework to another to ensure greater compatibility with our goals.|
...
| **Eoghan Murch**  | Implemented **File Handling Improvements**, including tracking the currently open file, saving to a new file or current file, and opening the current file and displaying it. <br> Added **auto-save functionality**, adding an auto-save system that can start/stop automatically based on file status, and global settings for enabling, disabling and adjusting the interval.<br> Added **UI enhancements**, including displaying the current file name live in the status bar and adding auto-save settings with a slider, checkbox, and status labels. <br> **Used Git** for collaborative development, version control and code reviewing. | 
